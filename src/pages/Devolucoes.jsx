...
export default function Devolucoes() {
  ...
  const { data: devolucoes = [], isLoading } = useQuery({ queryKey: ['devolucoes'], queryFn: () => base44.entities.Devolucao.list('-created_date'), initialData: [] });
  const { data: vendas = [] } = useQuery({ queryKey: ['vendas'], queryFn: () => base44.entities.Venda.list(), initialData: [] });
