          ...
          <div key={dataStr}>
            ...
            <div className="grid gap-3">
              {entregasPorData[dataStr].map(entrega => {
                ...
                return (
                  <div key={entrega.id} className={`bg-white dark:bg-neutral-900 border rounded-lg p-4 shadow-sm transition-all ${entrega.status_confirmacao === 'Confirmada' ? 'border-l-4 border-l-green-500' :
