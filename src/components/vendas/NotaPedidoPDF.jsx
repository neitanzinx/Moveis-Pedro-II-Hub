...
export function gerarNotaPedidoHTML(venda, cliente, vendedor) {
  ...
  const itensHTML = venda.itens.map(item => `
    <tr>
      <td style="padding: 8px 10px; border-bottom: 1px solid #e5e5e5;">${item.produto_nome}</td>
    ...
    <body>
      <div class="header">
        <div class="header-left">
          <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/690ce4cb64e20af6b4a46b6f/3474ff954_undefined-Imgur.png" alt="Logo" class="logo-img" />
